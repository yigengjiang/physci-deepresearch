"""OpenAI request-parameter typing helpers.

Vendored VERBATIM from `core/utils/openai_utils/types.py` (origin/submit).
Imports only `httpx` + `openai.*` — leak-free. Do not edit the body.
"""
